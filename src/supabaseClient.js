...
export default function AdminDashboard({ onBack }) {
  ...
  // 2. Fetch all payment requests (showing pending or all for verification)
          ...
          <div className="space-y-4">
            ...
            {pendingPayments.length === 0 ? (
              <div className="rounded-2xl bg-[#16171d] border border-gray-800 p-12 text-center shadow-xl">
                ...
                <p className="text-xs text-gray-400 mt-1">There are no UTR records found in the payments table.</p>
              </div>
            ) : (
